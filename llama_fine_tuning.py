...
Original file is located at
    https://colab.research.google.com/drive/1EZwA3RkZV9seIrGk4MiiiJbJmqAFw__M
...
Category:"""
    ...
    # Match to closest category if not exact
    if predicted not in categories:
        ...
        for cat in categories:
            ...
            # If still no match, default to most common category or first one
